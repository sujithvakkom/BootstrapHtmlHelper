...
#line hidden
#line hidden
        public static HelperResult GridInitScript(MyWebGrid webGrid, HttpContextBase httpContext)
        {
...
#line hidden
        public static HelperResult Table(MyWebGrid webGrid,
                                         ...
                                         System.Func<dynamic, object> footer,
                                         object htmlAttributes)
        {
            return new HelperResult(__razor_helper_writer =>
            {
                ...
                var htmlAttributeDictionary = System.Web.Mvc.HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes);
                if (webGrid.IsAjaxEnabled)
                {
...
#line hidden
            ...
            bool renderAjaxContainer)
        {
            return new HelperResult(__razor_helper_writer =>
            {
                ...
                if (ModeEnabled(mode, MyWebGridPagerModes.FirstLast) && currentPage > 1)
                {
                ...
                if (ModeEnabled(mode, MyWebGridPagerModes.NextPrevious) && currentPage > 0)
                {
                ...
                if (ModeEnabled(mode, MyWebGridPagerModes.NextPrevious) && (currentPage < lastPage))
                {
                ...
                if (ModeEnabled(mode, MyWebGridPagerModes.FirstLast) && (currentPage < lastPage - 1))
                {
        ...
        private static bool ShowSortableColumnHeader(MyWebGrid grid, WebGridColumn column)
        {
            return grid.CanSort && column.CanSort && !column.ColumnName.IsEmpty();
        }

        public static IHtmlString GridLink(MyWebGrid webGrid, string url, string text)
        {
            ...
            if (webGrid.IsAjaxEnabled)
            {
                ...
                builder.MergeAttribute("data-ajax-mode", webGrid.AjaxOptions.InsertionModeString());

                builder.MergeAttribute("data-ajax-update", "#"+webGrid.AjaxUpdateContainerId);
            }
        ...
        private static string GetRowStyle(MyWebGrid webGrid, int rowIndex, string rowStyle, string alternatingRowStyle, string selectedRowStyle)
        {
