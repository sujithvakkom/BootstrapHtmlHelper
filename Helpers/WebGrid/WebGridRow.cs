...
namespace BootstrapHtmlHelper.Helpers
{
    ...
    public class WebGridRow : DynamicObject, IEnumerable<object>
    {
        ...
        public IEnumerator<object> GetEnumerator()
        {
            if (_values == null)
            {
                _values = _grid.ColumnNames.Select(c => MyWebGrid.GetMember(this, c));
            }
