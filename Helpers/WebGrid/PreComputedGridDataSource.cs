...
{
    /// <summary>
    /// Source wrapper for data provided by the user that is already sorted and paged. The user provides the MyWebGrid the rows to bind and additionally the total number of rows that 
    /// are available.
    /// </summary>
    internal sealed class PreComputedGridDataSource : IWebGridDataSource
    {
        ...
        public PreComputedGridDataSource(MyWebGrid grid, IEnumerable<dynamic> values, int totalRows)
        {
